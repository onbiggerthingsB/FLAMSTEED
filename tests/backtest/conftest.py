"""Phase-4 backtest tests: reuse the Phase-1/2/3 fixtures + load the backtest config."""
...
from tests.data.conftest import (  # noqa: F401
    ...
    matches_df,       # tiny date-spanning panel for window tests
)
...
def odds_fixture_path() -> Path:
    """The hand-built REAL-PARSE Odds API fixture (Brazil vs Croatia, h2h, bet_time+close)."""
    return _FIXTURE
