...
def _forecast_summary(forecast: dict, edge: dict | None = None) -> dict:
    ...
    for the forecast fields — this is a pure projection of a forecast the detail already gated.
    ...
    summary = {"most_likely": forecast["most_likely"], "one_x_two": forecast["one_x_two"]}
